...
import firstImg from '../assets/first-img.jpeg';
import secondImg from '../assets/second-img.jpeg';
                ...
                <div class="company-info-box px-primary d-flex align-items-center">
                    <div class="info-side">
                        <div class="info-side-box d-flex">
                            ...
                            <p class="info-text">
                                Managing your money shouldn’t be complicated.
                                Our powerful finance tracking platform helps you
                                track your income, expenses, savings, and
                                investments—all in one place.{' '}
                            </p>
                            <div class="btns-box d-flex">
                                <button class="login-btn get-started">
                                    Get Started
                                </button>
